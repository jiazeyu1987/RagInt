...
export function useControlBarProps({
  ...
  return useMemo(
    () => ({
      ...
      asrAutoSubmitOnWakeEnabled,
      onChangeAsrAutoSubmitOnWakeEnabled: setAsrAutoSubmitOnWakeEnabled,
      asrAutoResumeAfterAnswerEnabled,
      onChangeAsrAutoResumeAfterAnswerEnabled: setAsrAutoResumeAfterAnswerEnabled,
      asrAutoResumeAfterAnswerDelayMs,
      onChangeAsrAutoResumeAfterAnswerDelayMs: setAsrAutoResumeAfterAnswerDelayMs,
      asrConversationAutoSubmitSilenceMs,
      onChangeAsrConversationAutoSubmitSilenceMs: setAsrConversationAutoSubmitSilenceMs,
      asrConversationAutoSubmitScope,
      onChangeAsrConversationAutoSubmitScope: setAsrConversationAutoSubmitScope,
      asrConversationContextStrategy,
      onChangeAsrConversationContextStrategy: setAsrConversationContextStrategy,
      asrConversationContextRecentTurns,
      onChangeAsrConversationContextRecentTurns: setAsrConversationContextRecentTurns,
      asrConversationContextMaxTokens,
      onChangeAsrConversationContextMaxTokens: setAsrConversationContextMaxTokens,
      tourState,
      currentIntent,
      tourStops,
      ...
      saucWsUrl,
      onChangeSaucWsUrl: setSaucWsUrl,
      saucResourceId,
      onChangeSaucResourceId: setSaucResourceId,
      saucAppKey,
      onChangeSaucAppKey: setSaucAppKey,
      saucAccessKey,
      onChangeSaucAccessKey: setSaucAccessKey,
      saucModelName,
      onChangeSaucModelName: setSaucModelName,
      saucSegmentDurationMs,
      onChangeSaucSegmentDurationMs: setSaucSegmentDurationMs,
      saucEnableItn,
      onChangeSaucEnableItn: setSaucEnableItn,
      saucEnablePunc,
      onChangeSaucEnablePunc: setSaucEnablePunc,
      saucEnableDdc,
      onChangeSaucEnableDdc: setSaucEnableDdc,
      saucShowUtterances,
      onChangeSaucShowUtterances: setSaucShowUtterances,
      saucEnableNonstream,
      onChangeSaucEnableNonstream: setSaucEnableNonstream,
      asrRecognitionStage,
      asrPostProcessStage,
