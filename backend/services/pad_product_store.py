...
from backend.services.pad_product_paths import (
    CONTROL_HOTSPOT_SPECS,
    PRODUCT_SOURCE_IMPORTED,
    PRODUCT_SOURCE_MANUAL_PLACEHOLDER,
    _is_control_hotspot_product_id,
    _is_manual_placeholder_product_source,
    _normalize_hotspot_geometry,
    _normalize_optional_rel_path,
    _normalize_product_source,
    _normalize_rel_path,
    _normalize_station_id,
    _normalize_station_key,
    _safe_path_part,
)
